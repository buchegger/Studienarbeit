...
\begingroup
  ...
  \begin{picture}(8640.00,4032.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(7323,1559){\makebox(0,0)[r]{\strut{}q=0.6: Fit 0.0261$\cdot \exp({0.0970x})$}}%
      \csname LTb\endcsname%
      \put(7323,1383){\makebox(0,0)[r]{\strut{}q=0.7: Fit 0.0097$\cdot \exp({0.0935x})$}}%
      \csname LTb\endcsname%
      \put(7323,1207){\makebox(0,0)[r]{\strut{}q=0.8: Fit 0.0287$\cdot \exp({0.0764x})$}}%
      \csname LTb\endcsname%
      \put(7323,1031){\makebox(0,0)[r]{\strut{}q=0.9: Fit 0.0091$\cdot \exp({0.1098x})$}}%
      \csname LTb\endcsname%
      \put(7323,855){\makebox(0,0)[r]{\strut{}q=1.0: Fit 0.0088$\cdot \exp({0.1261x})$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{diskeccentricityfith004}}%
    \gplfronttext
  \end{picture}%
\endgroup
